...
|-----------------|--------|----------|----------------------------------------|
| [engineering](skills/engineering/)       | 3  | 0 | Minimal evidence for tests, debugging, metrics, docs, root cause, macOS disk recovery, and splitting large files into modules |
